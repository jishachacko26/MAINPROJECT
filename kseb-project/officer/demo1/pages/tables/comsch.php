                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM `com_sch`";
                        $result = $con->query($sql);
                         if ($result->num_rows > 0) {
                          while($row = $result->fetch_assoc()) {?>
                        <tr class="table-info">
                          <td> <?php echo $row["con_no1"]; ?>  </td>
                          <td> <?php echo $row["bill_no1"]; ?> </td>
                           <td> <?php echo $row["bulb1"]; ?> </td>
                          ...
                          <input type="hidden" name="comid1" value="<?php echo $row["comid1"]; ?>">
...
<script type="text/javascript">
  ...
  <?php
     ...
     {
        $sql = "UPDATE `com_sch` SET `status`='approved' WHERE `comid1`='$_POST[comid1]'  ";
...
<?php
     ...
     {
        $sql = "UPDATE `com_sch` SET `status`='reject' WHERE `comid1`='$_POST[comid1]'  ";
    ...
    <?php
     ...
     {
        $sql = "UPDATE `com_sch` SET `status`='pending' WHERE `comid1`='$_POST[comid1]'  ";
