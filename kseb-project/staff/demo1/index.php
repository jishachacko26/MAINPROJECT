            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src=""><a href="pages/forms/profile1.php">
                  <p class="mb-1 mt-3 font-weight-semibold"></p>
                  <p class="font-weight-light text-muted mb-0"></p>
                </div>
                <a class="dropdown-item"> <span class="badge badge-pill badge-danger">1</span><i class="dropdown-item-icon ti-dashboard"></i></a>
                ...
                <a class="dropdown-item"><i class="dropdown-item-icon ti-help-alt"></i></a>
          ...
          <ul class="nav">
           ...
           <!--  <li class="nav-item">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" href="http://localhost/KERALA%20STATE%20ELECTRICITY%20BOARD/staff/demo1/pages/forms/reg_list.php">
                <i class="menu-icon typcn typcn-bell"></i>
          ...
          <div class="content-wrapper">
              ...
              <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="pages/forms/billcalculation.php" class="btn btn-outline-primary btn-sm">
                            Click
                        </a>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Complaint View</h5>
                        <p class="card-text">
                           
                        </p>
                          
                        <a href="pages/forms/compliant.php" class="btn btn-outline-primary btn-sm">
                           Click
                        </a>
                        <!-- <a href="#" class="btn btn-outline-secondary btn-sm">
                            <i class="far fa-heart"></i></a> -->
