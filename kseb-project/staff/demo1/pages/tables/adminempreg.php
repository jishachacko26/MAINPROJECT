...
<html lang="en">
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr class="table-info">
                          <td> <?php echo $row["consumer number"]; ?>  </td>
                          ...
                          <a href="delete.php?rid=<?php echo $row["bill"]; ?>"class="del_btn">Delete</a>
      
                          <button type="submit" name="delete" a href="delete.php?rid=<?php echo $row["billid"]; ?>"class="del_btn"></a>APPROVE</button>
  ...
  $sql="INSERT INTO bill(consumer_no,status,l_id)VALUES ('$_POST[co_no]','$_POST[co_type]','pending','$usr')";
