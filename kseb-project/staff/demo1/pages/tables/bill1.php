                  ...
                  <div class="card-body">
                    <h4 class="card-title"></h4>
                     ...
                     <thead>
                                        ...
                                        <?php
                                            $id=$_SESSION['l_id'];
                                            $query1 = "SELECT COUNT(login.usename) FROM login,bill WHERE login.l_id=bill.rid AND l_id={$id}";
                                            $result1 = mysqli_query($con,$query1);
                                            $row1 = mysqli_fetch_row($result1);
                                            $numrows = $row1[0];
                                            include("paging1.php");
                                            $result = retrieve_bills_generated($_SESSION['l_id'],$offset, $rowsperpage);
