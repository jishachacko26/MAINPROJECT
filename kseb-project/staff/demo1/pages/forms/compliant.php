                  ...
                  <div class="card-body"style="overflow: scroll;">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                       ...
                       $sql= "SELECT register.fullname,register.ph ,complaint3.co_no,complaint3.co_type,complaint3.location,complaint3.description,complaint3.status FROM register INNER JOIN complaint3 ON register.rid = complaint3.l_id";
...
function stateHandle() {
  ...
  <?php
     ...
     if(isset($_POST['approve']))
     {
      ...
      $cono = $_POST['co_no'];
        $sql = "UPDATE `complaint3` SET `status`='approved' WHERE `co_no`='$cono' ";
...
<?php
     ...
     {
      $cono = $_POST['co_no'];
        $sql = "UPDATE `complaint3` SET `status`='reject' WHERE `co_no`='$cono'";
    ...
    <?php
     ...
     {
      $cono = $_POST['co_no'];
        $sql = "UPDATE `complaint3` SET `status`='verify' WHERE `co_no`='$cono'  ";
    ...
    <?php
     ...
     {
        $sql = "UPDATE `complaint3` SET `status`='pending' WHERE `c_id`='$_POST[c_id]'  ";
