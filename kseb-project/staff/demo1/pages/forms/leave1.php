                  ...
                  <div class="col-12 stretch-card">
                    <div class="card">
                      ...
                      <form action="" method="post">
                          ...
                          <button type="submit" name="approve" style="background-color: green"><a href="leave_approved.php">APPROVE</a></button>
                          <button type="submit" name="reject" class="btn-success btn" style="background-color: 
                          red"><a href="leave_pending.php">REJECT</a></button>
                       ...
                       "enctype="multipart/form-data"onsubmit ="return validateForm()">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="firstname" name="fname" required=""class="form-group__names"  required onchange="Validate();">
...
document.getElementById('msg1').innerHTML=" ";
    return true;
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="lastname" name="lname" required=""class="form-group__names"  required onchange="Validate2();">
...
document.getElementById('msg2').innerHTML=" ";
  ...
  $sql="INSERT INTO leave1(fname,lname,leave_type, start_date,end_date,leave_session1,applied_on,status)VALUES 
  ('$_POST[fname]','$_POST[lname]','$_POST[leave_type]','$_POST[start_date]','$_POST[end_date]','$_POST[leave_session1]','$_POST[applied_on]','pending')";
