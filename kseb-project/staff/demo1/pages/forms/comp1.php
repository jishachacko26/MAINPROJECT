                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM `comp_verify`where status='pending'";
                        ...
                        <tr class="table-info">
                          ...
                          <form action="generate_pdf.php" method="post">
                            ...
                            <button type="submit"id="pdf" name="generate_pdf"style="background-color: green"><a href="http://localhost/KERALA%20STATE%20ELECTRICITY%20BOARD/staff/demo1/pages/forms/generate_pdf.php">download</a></button>
