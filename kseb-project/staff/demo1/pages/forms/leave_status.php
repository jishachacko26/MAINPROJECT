...
?>
  ...
  <?php
     ...
     {
        $sql = "UPDATE `leave1` SET `status`='approved' WHERE `leave_id`='$_POST[leave_id]'  ";
...
<?php
     ...
     {
        $sql = "UPDATE `leave1` SET `status`='reject' WHERE `leave_id`='$_POST[leave_id]'  ";
    ...
    ?>
     ...
     {
        $sql = "UPDATE `leave1` SET `status`='verify' WHERE `leave_id`='$_POST[leave_id]'  ";
    ...
    <?php
     ...
     {
        $sql = "UPDATE `leave1` SET `status`='pending' WHERE `leave_id`='$_POST[leave_id]'  ";
