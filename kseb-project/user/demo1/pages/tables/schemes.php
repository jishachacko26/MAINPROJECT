      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/KERALA%20STATE%20ELECTRICITY%20BOARD/user/demo1/pages/tables/adminempreg.php">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                       <!-- <?php
                        require("../forms/userconnection.php");
                        ...
                        <tr class="table-info">
                          ...
                          <a href="delete.php?rid=<?php echo $row["rid"]; ?>"class="del_btn">Delete</a>
      
                          <button type="submit" name="delete" a href="delete.php?rid=<?php echo $row["id"]; ?>"class="del_btn"></a>APPROVE</button>
                    ...
                    <button type="submit" name="Apply" class="btn-success btn"><a href="../allschemes.php">Apply</button>
                      </tbody>
                    </table>
                  </div>
                </div>
