...
<html lang="en">
                      ...
                      <div class="card-body">
                       ...
                       <form class="forms-sample" method="post" action="" onsubmit ="return validateForm()"name ="myform">
                        <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">home connection</label>
                            <div class="col-sm-9">
                              <button type="submit"  class="btn btn-success mr-2"><a href="home.php">home connection</a></button>
                            </div>
                            </div>
                            
                            <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">commercial connection</label>
                            <div class="col-sm-9">
                              <button type="submit"  class="btn btn-success mr-2"><a href="commecricial.php">  commercial connection</a></button>
                            </div>
                            </div>
                            <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">farm connection</label>
                            <div class="col-sm-9">
                              <button type="submit"  class="btn btn-success mr-2"><a href="farming.php">   farm connection</a></button>
                            </div>
                            </div>

                           
                           <!--<label for="exampleInputEmail2" class="col-sm-3 col-form-label">connection type</label>
                            <div class="col-sm-9">
                             <select class="form-control" name="connection_type" required="">
                              <option><a href="home.php">Home</a></option>
                               <option><a href="economical.php"> Economical Purpouse</a></option>
                                <option><a href="commercial.php"> commercial purpouse</a></option>
                                <option><a href="farming"> Farming</a></option> 
                           ...
                           <!--<div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">cardnumber</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="cardnumber" name="cardnumber">
                            </div>
                          </div>
                           <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">quantity</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="quantity" name="quantity">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Rate</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="Rate" name="rate">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="date" class="form-control" id="exampleInputPassword2" placeholder="date" name="date">
                            </div>
                          </div>-->
  ...
  $sql="INSERT INTO connection(ho_no,connection_type,status,l_id)VALUES ('$_POST[ho_no]','$_POST[connection_type]','pending','$usr')";
