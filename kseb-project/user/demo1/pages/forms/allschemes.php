                      ...
                      <div class="card-body">
                       ...
                       <form class="forms-sample" method="post" action="">
                        <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">home scheme</label>
                            <div class="col-sm-9">
                              <button type="submit"  class="btn btn-success mr-2"><a href="home_sch.php">home scheme</a></button>
                            </div>
                            </div>
                            
                            <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">commercial scheme</label>
                            <div class="col-sm-9">
                              <button type="submit"  class="btn btn-success mr-2"><a href="com_sch.php">  commercial scheme</a></button>
                            </div>
                            </div>
                            <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">farm scheme</label>
                            <div class="col-sm-9">
                              <button type="submit"  class="btn btn-success mr-2"><a href="f_sch.php">   farm scheme</a></button>
                            </div>
                            </div>
