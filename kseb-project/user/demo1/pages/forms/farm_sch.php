...
var x = document.forms["myform"]["adhno"].value;
                    ...
                    <div class="card">
                      ...
                      <h4 class="card-title">farming</h4>
                       ...
                       "enctype="multipart/form-data"onsubmit ="return validateForm()">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder=" consumer number" name="con_no" required="">
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <p>Electricty bill Number Last 5 digits</p>
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="Electricty bill Number Last 5 digits" name="bill_no" required="">
                            </div>
                          </div>
                          
                          <!-- <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">bulb </label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="bulb" name="bulb" required="">
                            </div>
                          </div> -->
  ...
  $sql="INSERT INTO f_ch(con_no,bill_no,bulb,l_id)VALUES 
  ('$_POST[con_no]','$_POST[bill]','$_POST[bulb]','pending',$usr)";
...
<!--<?php
  ...
  $sql="INSERT INTO farm(f_name,f_no,place,panchayathu,ward,Address,adhno,adhaar,own,signature,status,l_id)VALUES ('$_POST[f_name]','$_POST[f_no]','$_POST[place]','$_POST[panchayathu]','$_POST[ward]','$_POST[Address]','$_POST[adhno]','$adhaar','$own','$sig','pending',$usr)";
