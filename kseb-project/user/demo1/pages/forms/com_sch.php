              ...
              <div class="col-md-6 d-flex align-items-stretch grid-margin">
                <div class="row flex-grow">
                  ...
                  <div class="col-12 stretch-card">
                    <div class="card">
                      <div class="card-body">
                      <h4 class="card-title">Commercial Scheme</h4>
...
function Validateaa() 
{
    ...
    if (!val.match(/^[0-9]{12}/)) 
    {
        document.getElementById('msg').innerHTML="Only Numbers are allowed and must contain 12 number";
...
document.getElementById('msgbill').innerHTML=" ";
  ...
  $sql="INSERT INTO com_sch(con_no1,bill_no1,bulb1, status,l_id)VALUES 
  ('$_POST[con_no1]','$_POST[bill_no1]','$_POST[bulb1]','pending',$usr)";
