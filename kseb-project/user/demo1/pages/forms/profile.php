...
<html lang="en">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="pages/forms/stock.php">
                <i class="menu-icon typcn typcn-document-text"></i>
            ...
            <li class="nav-item">
              <a class="nav-link" href="pages/forms/products.php">
                      ...
                      <div class="card-body">
                       ...
                       <form class="forms-sample" method="post" action="">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="Username" name="name">
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">idukki</label>
                            <div class="col-sm-9">
                              
                            </div>
                            <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Upputhara substation
                            </label>
                            <div class="col-sm-9">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="panchayathu" name="panchayathu">
                            </div>
                            <div class="form-group row">
                          ...
                          <!--  <label for="exampleInputEmail2" class="col-sm-3 col-form-label">panchayath</label>
                            <div class="col-sm-9">
                             <select class="form-control" name="co_type">
                              <option>Bill Not Correct</option>
                               <option> Bill Generated Late</option>
                                <option> Transaction Not Processed</option>
                                <option> Previous Complaint Not Processed</option> 
  ...
  $sql="INSERT INTO complaint2(co_no,co_type,status)VALUES ('$_POST[co_no]','$_POST[co_type]','pending')";
