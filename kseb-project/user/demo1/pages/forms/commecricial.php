                      ...
                      <h4 class="card-title">Commercial Connection</h4>
                       ...
                       "enctype="multipart/form-data"onsubmit ="return validateForm()">
                          ...
                          <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Building Number</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="shop number" name="shop_no"onclick="allnumeric(document.form1.text1)" required=""onchange="valcomp();">
                            </div>
