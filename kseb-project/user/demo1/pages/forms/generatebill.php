      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/KERALA%20STATE%20ELECTRICITY%20BOARD/user/demo1/index.php">
              ...
              <div class="col-lg-12 stretch-card">
                <div class="card">
                  <div class="card-body"style="overflow: scroll;">
                    <h4 class="card-title">process bill</h4>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM `bill1`where email='$usr'";
                        ...
                        <tr class="table-info">
                          ...
                          <td>    
                          <form action="http://localhost/KERALA%20STATE%20ELECTRICITY%20BOARD/staff/demo1/pages/forms/pdfgenerator/report1.php" method="post">
