...
function validateForm() {
  ...
  if (x == "" || x == null) {
    alert("farm name must be filled out");
    return false;
  }
                     ...
                     <div class="card-body">
                      <h4 class="card-title">farming</h4>
                       ...
                       "enctype="multipart/form-data"onsubmit ="return validateForm()">
                            ...
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">farm name</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder=" farm name" name="f_name" required="">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">farm number</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="farm number" name="f_no" required=""onchange="valcomp();">
                            </div>
...
document.getElementById('co3').innerHTML=" ";
  ...
  window.history.forward();
    ...
    $sql="SELECT * FROM `commecrial` where `f_no`='$f_no'";
        ...
        $sql="INSERT INTO farm(`f_name`,`f_no`,`place`,`panchayathu`,`ward`,`Address`,`district`,`adhno`,`adhaar`,`own`,`signature`,`status`,`l_id`)VALUES ('$f_no','$f_name','$place','$panchayathu','$ward','$Address','$district','$adhno','$fileName01','$fileName02','$fileName03','pending',$usr)";
