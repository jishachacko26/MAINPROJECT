                      ...
                      <div class="card-body">
                       ...
                       <form class="forms-sample" method="post" action="" onsubmit ="return validateForm()"name ="myform">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="con" name="co_no" required="">

                     </div>
                     <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">bill number</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="bilkl number (last 5 digits)" name="bill" required="">
