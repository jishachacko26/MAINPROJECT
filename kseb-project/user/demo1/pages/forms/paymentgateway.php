...
if($r[4]==1)
{
  ...
  $query1="SELECT * FROM register where l_id ='$l_id'";
...
<?php
         $u=$_SESSION['l_id'];
            $l=$_GET['bill_id'];
            $query5 ="SELECT * FROM bill1 where l_id='$u' and bill_id='$l'";
...
<form action="billcalaculation.php?id=<?php echo $l;?>" method="post">
<script
