...
<?php
         $u=$_SESSION['log_id'];
            $l=$_GET['id'];
            $query5 ="SELECT * FROM booking_tbl where log_id='$u' and bk_id='$l'";
...
<section>
      <div class="product">
        <div class="description">
          <h3>The AmountPay By: <?php echo $r1['name'];?> <?php echo $r1['lname'];?></h3>
          <h3>The Amount : <?php echo $r5['trate'];?> </h3>
        </div>
      </div>

<form action="bill.php?id=<?php echo $l;?>" method="post">
<script
    src="https://checkout.razorpay.com/v1/checkout.js"
    data-key="<?php echo $apiKey; ?>" // Enter the Test API Key ID generated from Dashboard → Settings → API Keys
    data-amount="<?php echo $r5['trate']  * 100;?>" // Amount is in currency subunits. Hence, 29935 refers to 29935 paise or ₹299.35.
    ...
    data-name="Autors-Vehicle BreakDown Assistance"
...
></script>
<input type="hidden"   name="bkid" value="<?php echo $l; ?>">
