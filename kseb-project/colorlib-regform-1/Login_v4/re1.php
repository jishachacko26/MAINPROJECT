...
$email_to = $email;
$fromserver = "ksebproject2022@gmail.com"; 
require("PHPMailer/PHPMailerAutoload.php");
$mail = new PHPMailer();
$mail->IsSMTP();
$mail->Host = "mail.yourwebsite.com"; // Enter your host here
$mail->SMTPAuth = true;
$mail->Username = "ksebproject2022@gmail.com"; // Enter your email here
$mail->Password = "yycqspsnxcomeaoe"; //Enter your password here
$mail->Port = 25;
$mail->IsHTML(true);
$mail->From = "ksebproject2022@gmail.com";
