                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr class="table-info">
                          ...
                          id" value="<?php echo $row["rid"]; ?>">
                          <!-- <button type="submit" name="approve" class="btn-success btn">APPROVE</button>
                          <button type="submit" name="reject" class="btn-success btn">REJECT</button> -->
                        </form>
                        </td>
                        </tr>
                      <?php
