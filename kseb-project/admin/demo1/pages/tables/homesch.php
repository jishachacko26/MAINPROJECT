...
<html lang="en">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth">
                ...
                <span class="menu-title">Scheme Status</span>
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="http://localhost/KERALA%20STATE%20ELECTRICITY%20BOARD/admin/demo1/pages/tables/homesch.php"> Home Scheme </a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#"> Commercial Connection </a>
                  </li>
                  <li class="nav-item">
 ...
 -->
             ...
             <li class="nav-item">
              <a class="nav-link" href="pages/forms/officeradd.php">
                <i class="menu-icon typcn typcn-bell"></i>
