...
<script type="text/javascript">
  ...
  <?php
     ...
     {
        $sql = "UPDATE `commecrial` SET `status`='approved' WHERE `sno`='$_POST[sno]'  ";
...
<?php
     ...
     {
        $sql = "UPDATE `commecrial` SET `status`='reject' WHERE `sno`='$_POST[sno]'  ";
    ...
    ?>
     ...
     {
        $sql = "UPDATE `commecrial` SET `status`='verify' WHERE `sno`='$_POST[sno]'  ";
