...
function stateHandle() {
  ...
  <?php
     ...
     {
      $leave_id1= $_POST['leave_id1'];
        $sql = "UPDATE `ofleave` SET `status`='approved' WHERE `leave_id1`='$leave_id1'  ";
...
<?php
     ...
     {
      $leave_id1 = $_POST['leave_id1'];
        $sql = "UPDATE `ofleave` SET `status`='reject' WHERE `leave_id1`='$leave_id1'  ";
