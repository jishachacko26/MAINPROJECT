          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-lg-12 stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">process Leave</h4>
  ...
  <?php
     ...
     if(isset($_POST['approve']))
     {
      $leave_id = $_POST['leave_id'];
        $sql = "UPDATE `leave1` SET `status`='approved' WHERE `leave_id`='$leave_id'  ";
...
<?php
     ...
     {
      $leave_id = $_POST['leave_id'];
        $sql = "UPDATE `leave1` SET `status`='reject' WHERE `leave_id`='$leave_id'  ";
    ...
    <?php
     ...
     {
        $sql = "UPDATE `leave` SET `status`='pending' WHERE `leave_id`='$_POST[leave_id]'  ";
