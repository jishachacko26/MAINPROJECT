                      ...
                      <div class="card-body">
                       ...
                       <form class="forms-sample" method="post" action="">
                          <div class="form-group row">
                            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">consumer number</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="consumer number" name="con" required="">
                            </div>
                          </div>
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="billnumber" name="billnum" required="">
                            </div>
                          </div>
                          <!-- <div class="form-group row">
...
$sql="INSERT INTO officeradd(name,password)VALUES ('$_POST[name]','$_POST[password]')";
