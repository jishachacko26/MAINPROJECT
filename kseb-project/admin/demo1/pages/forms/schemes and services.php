                      ...
                      <div class="card-body">
                       ...
                       <form class="forms-sample" method="post" action="">
                          <div class="form-group row">
                            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">bulb name</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="bulbname" name="bulbname">
                            </div>
                          </div>
                           ...
                           <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">notication</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="exampleInputPassword2" placeholder="notifications" name="not">
                            </div>
                          </div>
                          <!--<div class="form-group row">
                          ...
                          <button type="submit" name="submit" class="btn btn-success mr-2">ADD</button>
...
$sql="INSERT INTO officeradd(name,designation,email,password)VALUES ('$_POST[name]','$_POST[designation]','$_POST[email]','$_POST[password]')";
