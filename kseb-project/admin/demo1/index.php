          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="row">
                 ...
                 <CENTER> <p ><h1 style="color:blue;">KERALA STATE ELECTRICITY BOARD<h1></p></CENTER>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="pages/tables/complaint view.php" class="btn btn-outline-primary btn-sm">
                            Click
                        </a>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"> Staff Leave Management</h5>
                        <p class="card-text">
                           
                        </p>
                          
                        <a href="pages/tables/leave_management.php" class="btn btn-outline-primary btn-sm">
                           Click
                        </a>
                        <!-- <a href="#" class="btn btn-outline-secondary btn-sm">
                            <i class="far fa-heart"></i></a> -->
            ...
            <div class="col-lg-6 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Officer Leave Management</h5>
                        <p class="card-text">
                           
                        </p>
                          
                        <a href="pages/tables/ofleavemanagement.php" class="btn btn-outline-primary btn-sm">
                           Click
                        </a>
                        <!-- <a href="#" class="btn btn-outline-secondary btn-sm">
                            <i class="far fa-heart"></i></a> -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">User List View</h5>
                        <p class="card-text">
                           
                        </p>
                          
                        <a href="pages/tables/reg_list.php" class="btn btn-outline-primary btn-sm">
                           Click
                        </a>
                        <!-- <a href="#" class="btn btn-outline-secondary btn-sm">
                            <i class="far fa-heart"></i></a> -->
